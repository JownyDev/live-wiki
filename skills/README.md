...
This directory contains **Agent Skills** for Live-Wiki following the [Agent Skills open standard](https://agentskills.io). Skills provide domain-specific patterns, conventions, and guardrails that help AI coding assistants (Claude Code, OpenCode, Cursor, etc.) understand project-specific requirements.
...
This configures each tool so it can discover skills:

| Tool | Setup |
|------|-------|
| Claude Code / OpenCode | `.claude/skills/` symlink + `CLAUDE.md` copies |
| Codex (OpenAI) | `.codex/skills/` symlink (AGENTS.md is native) |
...
6. Run `bash ./skills/skill-sync/assets/sync.sh` to update AGENTS.md
...
- [Live-Wiki AGENTS.md](../AGENTS.md) - AI agent general rules
