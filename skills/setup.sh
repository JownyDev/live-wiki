#!/bin/bash
# Setup AI Skills for Live-Wiki development
...
#
# Usage:
#   bash ./setup.sh              # Interactive mode (select AI assistants)
#   bash ./setup.sh --all        # Configure all AI assistants
#   bash ./setup.sh --claude     # Configure only Claude Code
#   bash ./setup.sh --claude --codex  # Configure multiple
...
show_help() {
    ...
    echo ""
    echo "Configure AI coding assistants for Live-Wiki development."
    echo ""
    echo "Options:"
...
echo "🤖 Live-Wiki AI Skills Setup"
echo "=========================="
echo ""
