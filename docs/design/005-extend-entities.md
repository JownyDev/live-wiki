...
### Element
- [x] **Origen (localización flexible, igual que Character)**  
...
- [x] `origin`: referencia tipada con el mismo formato y tipos permitidos que `origin` en Character.
